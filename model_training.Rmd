...
vars <- c("ph_ptf.000_030_cm",
          ...
          other_vars,
          # remove matching ssurgo derivative
          c("mlra_rs", "ssurgo_pm_lu3_rs_mode_v2")
          )
train2 <- na.exclude(train[vars])
...
ph_rf_030 <- train(y = train2$ph_ptf.000_030_cm, x = train2[idx], 
...
# save(ph_rf_030, ph_rf_100, file = "C:/Users/Stephen.Roecker/Nextcloud/projects/2020_gsp-sas/ph_rf.RData")
...
rs2 <- rs[[idx]]
ph_030_r <- predict(rs2, ph_rf_030$finalModel, fun = predfun, index = 1, progress = "text", overwrite = TRUE, filename = "D:geodata/project_data/gsp-sas/ph_030_qrf_mlra_pm_NULL_final.tif")
...
rs2 <- rs[[idx]]
ph_100_r <- predict(rs2, ph_rf_100$finalModel, fun = predfun, index = 1, progress = "text", overwrite = TRUE, filename = "D:geodata/project_data/gsp-sas/ph_100_qrf_mlra_pm_NULL_final.tif")
