...
gdalUtils::gdalwarp(
    ...
    dstfile = "D:/geodata/soils/gnatsgo_fy20_90m.tif",
    r = "mode",
    tr = c(90, 90),
    ot = "Int32",
    verbose   = TRUE,
...
r <- raster("D:/geodata/soils/gnatsgo_fy20_1000m.tif")
r2 <- r[1:100, 1:100, drop = FALSE]
r2 <- ratify(r2)
rat <- levels(r2)[[1]]
levels(r) <- mu_agg

vars <- c("pmkind3", "ph_r.i0-30", "ph_r.i30-100", "ec_r.i0-30", "ec_r.i30-100")[c(-1, - 2)]
lapply(vars, function(x) {
  cat(x, as.character(Sys.time()), "\n")
  deratify(r, att = x, 
           filename = paste0("D:/geodata/soils/gnatsgo_fy20_1000m_", x, ".tif"),  
