...
data <- within(data, {
  ...
  us_evc_mj[is.na(us_evc_mj)] = "missing"
  us_evc_mj          = as.factor(us_evc_mj)
  })

save(data, isric_vars, other_vars, ssurgo_vars, file = "K:/GSP/modeling/predict/training_data1.RData")
...
save(data, train, test, clhs_pkey, isric_vars, other_vars, ssurgo_vars, file = "K:/GSP/modeling/predict/training_data.RData")
...
#vars_cor <- findCorrelation(na.exclude(data2), names = TRUE) #this didn't help
